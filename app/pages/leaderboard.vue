...
useSeoMeta({
  title: 'Рейтинг — FrontSkill',
  description: 'Таблица лидеров FrontSkill — лучшие фронтенд-разработчики по XP, стрикам и решённым задачам.',
  ogTitle: 'Рейтинг — FrontSkill',
  ogDescription: 'Таблица лидеров FrontSkill — лучшие фронтенд-разработчики по XP, стрикам и решённым задачам.',
})
